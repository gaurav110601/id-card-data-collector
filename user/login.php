...
<?php    
    ...
    $_SESSION['form_table_name'] = $data['form_table_name'];
    $_SESSION['form_table_attributes'] = $data['form_table_attributes'];
...
<head>
    <meta charset="utf-8" />
    <title>Log In | User | ID Card Generator</title>
                                    ...
                                    <div class="p-4 my-auto">
                                        ...
                                        <form method="POST">
                                            ...
                                            <div class="mb-0 text-start">
                                                <button class="btn btn-soft-primary w-100" type="submit" name="user-login"><i
