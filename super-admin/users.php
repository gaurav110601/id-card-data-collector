...
$table_search = "";
    ...
    $result = mysqli_query($conn, $query);
            ...
            // echo $table_search;
            $query = "SELECT * FROM users WHERE and name LIKE '%$table_search%' or  mob_no LIKE '%$table_search%' or  email LIKE '%$table_search%' or  password  LIKE '%$table_search%' or  form_name  LIKE '%$table_search%' ORDER BY id DESC LIMIT {$offset},{$limit}";
    $result = mysqli_query($conn, $query);
        }
