...
<?php    
    ...
    if(isset($_GET['super-admin-logout'])){
        session_destroy();
?>
        <script type="text/javascript">
...
<!-- Mirrored from themes.getappui.com/techzaa/velonic/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Nov 2023 06:50:51 GMT -->
<head>
        <meta charset="utf-8" />
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle arrow-none nav-user" data-bs-toggle="dropdown" href="#" role="button"
                                ...
                                <span class="account-user-avatar">
                                    <img src="assets/images/super-admin.jpg     " alt="user-image" width="32" class="rounded-circle">
                                </span>
                                <span class="d-lg-block d-none">
                                    <h5 class="my-0 fw-normal"><?php echo $_SESSION['super-admin-name']; ?> <i
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                                ...
                                <!-- item-->
                                <a role="button" href="header.php?super-admin-logout" class="dropdown-item">
