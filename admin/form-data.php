...
$table_search = "";
        ...
        $form_id = $_GET['view'];
        $query_view = "SELECT * FROM users WHERE form_id = $form_id";
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">View Form Data</li>
                                    </ol>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <form method="POST" action="export.php">
                                        ...
                                        <button class="btn btn-success" style="margin-top: -10px;" type="submit" onclick="download_zip()" name="export">
                                            <b>Export</b>
                                        </button>
                                    </form>
                                    <a id="zip" style="visibility: hidden;" href="assets/images/photos/<?php echo $form_name.'.zip'; ?>" download>zip</a>
                                    <script>
                            ...
                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                            ...
                                            <?php
                                                ...
                                                while($form_attributes_data = mysqli_fetch_assoc($rs_attributes)) {
                                                    ...
                                                    if($form_attributes_data['input_type'] == 'file'){
                                                        ?>
                                                            <th> <img src="assets/images/photos/<?php echo $form_table_name."/".$data2[$val]; ?>" width="100px" height="100px"> </th>
                                                        <?php
                                                    }else{
                                                        ?>
                                                            <th> <?php echo $data2[$val]; ?> </th>
                                                        <?php
                                                    }
                                                }
                                            ?>
                                    ...
                                    <?php
                                        $sn++;
                                            ...
                                            <td colspan="8"> <center><span style="color:red;">No data found<br>Create User and tell them to fill Form</span></center> </td>
