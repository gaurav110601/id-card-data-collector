<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = 'INSERT INTO forms (form_name, form_description, form_table_name, form_table_attributes, institute_name,active, admin_id) 
        VALUES ("'.$form_name.'", "'.$form_description.'", "'.$form_table_name.'", "'.$form_table_attributes.'", "'.$institute.'", 1, "'.$admin_id.'")';
        ...
        foreach ($input_field_name as $key => $value) {
            ...
            VALUES ("'.$value.'", "'.$input_type[$key].'", '.$input_length[$key].', "'.$_POST["required$key"].'")';
            ...
            $query_form_table_add_column = 'ALTER TABLE '.$form_table_name.' ADD '.str_replace(".","",str_replace("'","",str_replace(' ','_',$value))).' varchar(100)';
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="example-select" name="admin_id" required>
                                                        ...
                                                        <?php
                                                            $query = "SELECT * FROM admins where id = ".$_SESSION['admin-id']." and active =1 ORDER BY id DESC";
